...
// NewChiefOfStateServiceServer creates a new instance of ChiefOfStateServiceServer. It also registers a cleanup function to assert the mocks expectations.
func NewChiefOfStateServiceServer(t testing.TB) *ChiefOfStateServiceServer {
