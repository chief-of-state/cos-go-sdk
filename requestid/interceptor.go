...
// NewUnaryServerInterceptor creates a new request ID interceptor.
...
// NewStreamServerInterceptor creates a new request ID interceptor.
// This interceptor adds a request ID to each grpc request
...
// NewUnaryClientInterceptor creates a new request ID unary client interceptor.
...
// NewStreamClientInterceptor  creates a new request ID stream client interceptor.
// This interceptor adds a request ID to each outgoing context
