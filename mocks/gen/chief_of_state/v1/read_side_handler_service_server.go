...
// NewReadSideHandlerServiceServer creates a new instance of ReadSideHandlerServiceServer. It also registers a cleanup function to assert the mocks expectations.
func NewReadSideHandlerServiceServer(t testing.TB) *ReadSideHandlerServiceServer {
